...
3-1. Copy the following code and paste it into your notebook (for tersoflow v1) :
    ...
    ```
3-2. This for tensorflow v2 (test at 2.17.1), and generate from AI (just for test):
